...
REQUIRED_PACKAGES = ['gspread', 'oauth2client', 'google-api-python-client', 'pysocks']
def ensure_packages(packages):
    ...
    # SOCKS_HOST = '192.168.5.235'  # Замените на ваш хост
    # SOCKS_PORT = 10808  # Замените на ваш порт
    # # # Настраиваем глобальный сокет для SOCKS5
...
try:
    ...
    skip_keyWords = [i.lower() for i in ['ТЗ', 'Шаблон', 'Данные', 'Изменения', 'Памятка', 'Архив']]
